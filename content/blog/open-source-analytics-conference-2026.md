...
# post thumb
images: ["images/blog/osa-con-2026.png"]
# author
author: "OSA CON Team"
---
<div style="width: 90%;max-width:500px; margin:0 auto;padding: 0 40px 20px" class="float-lg-start text-center"><img src="../../images/blog/osa-con-2026.png#center" alt="OSA CON 2026" style="max-width:100%;margin-bottom:10px;" /><br /><a href="https://luma.com/eis7567t?utm_source=osaconblogannouncement" target="_blank" rel="noopener">Pre-Register&nbsp;Here</a></div>

After five years as a fully virtual event, OSA Con is coming to San Francisco for its first in-person edition on November 2nd at the AWS Builder Loft. (If you are local, no worries - we will livestream it)! **[You can pre-register here](https://luma.com/eis7567t?utm_source=osaconblogannouncement).** 

This year’s conference focuses on what’s actually changing in data systems: how AI workloads reshape data infrastructure, how agents are being used to build analytics platforms, and how data feeds back into automated decision-making. Beyond AI, we’ll also cover real-time analytics, shared data architectures, and emerging open source applications.
There will be no vendor pitches. No inflated AI claims. Just technical talks from engineers building and running systems in production.
...
For updates, make sure to join our [Slack](https://go.osacom.io/slack) or sign up for updates [here](https://subscribepage.io/7rOdqZ). 
